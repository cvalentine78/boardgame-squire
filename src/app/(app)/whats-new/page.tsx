    ...
    <div className="pb-10 space-y-2">
      ...
      <section aria-labelledby="month-2026-06">
        ...
        <ol className="space-y-4 list-none">
          ...
          <li>
            <article aria-labelledby="entry-20260623-friends" className="bg-slate-800 border border-slate-700 rounded-2xl p-5 space-y-2">
              <header className="flex items-center gap-3 flex-wrap">
                <time dateTime="2026-06-23" className="text-xs text-slate-500 font-medium">June 23, 2026</time>
                <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${badge.new}`}>✨ New</span>
                <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${badge.sec}`}>🔒 Security</span>
